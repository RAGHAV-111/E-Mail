...
const Home = () => {
  ...
  const formHandler = (e) => {
    ...
    fetch(`https://project-1d90b-default-rtdb.firebaseio.com/${username}/sent.json`, {
      method: "POST",
    ...
    fetch(`https://project-1d90b-default-rtdb.firebaseio.com/${userReceived}/receiver.json`, {
      method: "POST",
